...
Follow [the first section](/docs/self-hosted/01-setup#creating-a-new-firebase-project) of the self host documentation if you want to get help creating a new Firebase project.
